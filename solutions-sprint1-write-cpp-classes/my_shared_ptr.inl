...
my_shared_ptr(my_unique_ptr<Y>&& other)
    : ptr{ other.release() }, refs{ make_refs() }
{
...
my_shared_ptr<T>&
my_shared_ptr<T>::
operator=(const my_shared_ptr& other) noexcept
{
...
my_shared_ptr<T>&
my_shared_ptr<T>::
operator=(const my_shared_ptr<Y>& other) noexcept
{
    my_shared_ptr tmp{ other };
    this->swap(tmp);
...
my_shared_ptr<T>&
my_shared_ptr<T>::
operator=(my_shared_ptr&& other) noexcept
{
    this->swap(other);
...
my_shared_ptr<T>&
my_shared_ptr<T>::
operator=(my_shared_ptr<Y>&& other) noexcept
{
    this->swap(other);
...
my_shared_ptr<T>&
my_shared_ptr<T>::
operator=(my_unique_ptr<Y>&& other)
{
    my_shared_ptr tmp{ other };
    this->swap(tmp);
...
void
my_shared_ptr<T>::
swap(my_shared_ptr& rhs) noexcept
{
...
bool
operator==(const my_shared_ptr<T1>& lhs,
           const my_shared_ptr<T2>& rhs) noexcept
{
...
template <class T>
bool
operator==(const my_shared_ptr<T>& lhs,
...
operator==(std::nullptr_t lhs,
           const my_shared_ptr<T>& rhs) noexcept
{
    return !rhs;
}
...
template <class T>
std::ostream&
operator<<(std::ostream& os, const my_shared_ptr<T>& rhs)
{
    os << rhs.get();
    return os;
}